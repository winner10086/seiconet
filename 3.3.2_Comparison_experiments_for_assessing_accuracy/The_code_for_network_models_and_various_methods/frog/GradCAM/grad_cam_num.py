...
def main():
    ...
    # load model weights
    model_weight_path = "../yuan_tu_gai_lv/AlexNet.pth"
    ...
    input_folder_path = "D:\pycharmBao\\biaoge\\frog\\one frog"
    output_folder_path = "D:\pycharmBao\\biaoge\\frog\one frog grad cam"
