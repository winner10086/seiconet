...
# Folder paths
original_folder_path = r"D:\pycharmBao\pythonProject2\Comparison experiments\Experimental Images\car\dual-target images\Annotated images\SeiCoNet"
annotated_folder_path = r"D:\pycharmBao\pythonProject2\Comparison experiments\Experimental Images\car\dual-target images\Annotated images\SeiCoNet"
...
for i in range(len(original_image_files)):
    ...
    for x in range(width):
        for y in range(height):
            ...
            if pixel[0] <= 240 and pixel[1] <= 255 and pixel[2] <= 240:
                count_object += 1
    ...
    for x in range(width):
        for y in range(height):
            ...
            if pixel[0] <= 80 and pixel[1] >= 150 and pixel[2] <= 80:
                count_annotated += 1
